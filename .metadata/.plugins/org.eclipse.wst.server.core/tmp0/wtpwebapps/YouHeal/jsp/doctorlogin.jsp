        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://images.pexels.com/photos/5934367/pexels-photo-5934367.jpeg"
              ...
              <div class="card-body p-4 p-lg-5 text-black">
				...
				<c:remove var="msg" scope="session"/>
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example17" name="email" placeholder="Email" autocomplete="off"  class="form-control form-control-lg" />
